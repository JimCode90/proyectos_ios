...
class OnBoardingViewController: UIPageViewController {
    ...
    func instanteViewController(_ index: Int) -> UIViewController{
        guard let viewController = UIStoryboard(name: "OnBoarding", bundle: Bundle.main).instantiateViewController(identifier: "OnBoardingStepts") as? OnBoardingSteptsViewController else {
